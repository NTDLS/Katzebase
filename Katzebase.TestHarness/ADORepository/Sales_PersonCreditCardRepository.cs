...
namespace Katzebase.TestHarness.ADORepository
{
    public partial class Sales_PersonCreditCardRepository
    {
        public void Export_Sales_PersonCreditCard()
        {
            ...
            if (client.Schema.Exists("AdventureWorks2012:Sales:PersonCreditCard"))
            {
                return;
            }
            ...
            client.Schema.Create("AdventureWorks2012:Sales:PersonCreditCard");
                    ...
                    using (SqlCommand command = new SqlCommand("SELECT * FROM Sales.PersonCreditCard", connection))
                    {
                        ...
                        using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
                        {
                            ...
                            while (dataReader.Read() /*&& rowCount++ < 10000*/)
                            {
                                ...
                                {
                                    Console.WriteLine("AdventureWorks2012:Sales:PersonCreditCard: {0}", rowCount);
                                }
                                ...
                                try
                                {
                                    client.Document.Store("AdventureWorks2012:Sales:PersonCreditCard", new KbDocument(new Models.Sales_PersonCreditCard
                                    {
