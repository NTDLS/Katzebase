...
namespace Katzebase.TestHarness.ADORepository
{
    public partial class Production_CultureRepository
    {
        public void Export_Production_Culture()
        {
            ...
            if (client.Schema.Exists("AdventureWorks2012:Production:Culture"))
            {
                return;
            }
            ...
            client.Schema.Create("AdventureWorks2012:Production:Culture");
                    ...
                    using (SqlCommand command = new SqlCommand("SELECT * FROM Production.Culture", connection))
                    {
                        ...
                        using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
                        {
                            ...
                            while (dataReader.Read() /*&& rowCount++ < 10000*/)
                            {
                                ...
                                {
                                    Console.WriteLine("AdventureWorks2012:Production:Culture: {0}", rowCount);
                                }
                                ...
                                try
                                {
                                    client.Document.Store("AdventureWorks2012:Production:Culture", new KbDocument(new Models.Production_Culture
                                    {
