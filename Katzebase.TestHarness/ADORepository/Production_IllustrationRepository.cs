...
namespace Katzebase.TestHarness.ADORepository
{
    public partial class Production_IllustrationRepository
    {
        public void Export_Production_Illustration()
        {
            ...
            if (client.Schema.Exists("AdventureWorks2012:Production:Illustration"))
            {
                return;
            }
            ...
            client.Schema.Create("AdventureWorks2012:Production:Illustration");
                    ...
                    using (SqlCommand command = new SqlCommand("SELECT * FROM Production.Illustration", connection))
                    {
                        ...
                        using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
                        {
                            ...
                            while (dataReader.Read() /*&& rowCount++ < 10000*/)
                            {
                                ...
                                {
                                    Console.WriteLine("AdventureWorks2012:Production:Illustration: {0}", rowCount);
                                }
                                ...
                                try
                                {
                                    client.Document.Store("AdventureWorks2012:Production:Illustration", new KbDocument(new Models.Production_Illustration
                                    {
