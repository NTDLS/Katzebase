...
namespace NTDLS.Katzebase.Engine.Indexes.Matching
{
    ...
    /// </summary>
    internal class IndexingConditionGroup<TData> where TData : IStringable
    {
        ...
        /// </summary>
        public List<IndexingConditionLookup<TData>> Lookups { get; set; } = new();
        ...
        /// </summary>
        public List<IndexingConditionGroup<TData>> SubIndexingConditionGroups { get; set; } = new();
