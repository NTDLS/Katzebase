...
namespace NTDLS.Katzebase.Engine.Query
{
    internal class StaticAggregateExpressionProcessor
    {
        ...
        /// Collapses a QueryField expression into a single value. This includes doing string concatenation, math and all recursive function calls.
        /// </summary>
        public static string CollapseAggregateQueryFieldExpression(Transaction transaction, PreparedQuery query,
            KbInsensitiveDictionary<List<string>> aggregationValues, KbInsensitiveDictionary<string?> auxiliaryFields, IQueryFieldExpression queryField)
        {
        ...
        /// Collapses a QueryField expression into a single value. This includes doing string concatenation, math and all recursive function calls.
        /// </summary>
        public static string CollapseAggregateExpressionFunctionParameter(Transaction transaction, PreparedQuery query,
            KbInsensitiveDictionary<List<string>> aggregationValues, KbInsensitiveDictionary<string?> auxiliaryFields, List<IQueryFieldExpressionFunction> functionDependencies, IExpressionFunctionParameter parameter)
        {
            if (parameter is ExpressionFunctionParameterString parameterString)
            {
                return CollapseAggregateFunctionStringParameter(transaction, query, aggregationValues, auxiliaryFields, functionDependencies, parameterString.Expression);
            }
            else if (parameter is ExpressionFunctionParameterNumeric parameterNumeric)
            {
                return CollapseAggregateFunctionNumericParameter(transaction, query, aggregationValues, auxiliaryFields, functionDependencies, parameterNumeric.Expression);
            }
            else
            {
            ...
            List<IQueryFieldExpressionFunction> functions, IQueryFieldExpressionFunction function)
        {
            ...
            {
                collapsedParameters.Add(CollapseAggregateExpressionFunctionParameter(transaction, query, aggregationValues, auxiliaryFields, functions, parameter));
            }

            //Execute function with the parameters from above ↑
            //var methodResult = AggregateFunctionImplementation.ExecuteFunction(transaction, function.FunctionName, collapsedParameters, auxiliaryFields);
...
namespace NTDLS.Katzebase.Engine.Query
{
    internal class StaticAggregateExpressionProcessor
    {
        ...
        public static string CollapseAggregateQueryField(Transaction transaction,
            PreparedQuery query, KbInsensitiveDictionary<string?> auxiliaryFields, QueryField queryField)
        {
            if (queryField.Expression is QueryFieldExpressionNumeric expressionNumeric)
            {
                return CollapseAggregateFunctionNumericParameter(transaction, query, auxiliaryFields, expressionNumeric.FunctionDependencies, expressionNumeric.Value);
            }
            else if (queryField.Expression is QueryFieldExpressionString expressionString)
            {
                return CollapseAggregateFunctionStringParameter(transaction, query, auxiliaryFields, expressionString.FunctionDependencies, expressionString.Value);
            }
            else if (queryField.Expression is QueryFieldDocumentIdentifier documentIdentifier)
            {
                if (auxiliaryFields.TryGetValue(documentIdentifier.Value, out var auxiliaryValue))
        ...
        static double[] CollapseAggregateFunctionNumericParameter(Transaction transaction,
            PreparedQuery query,
            KbInsensitiveDictionary<string?> auxiliaryFields,
            //KbInsensitiveDictionary<List<string>> groupedValues,
            List<IQueryFieldExpressionFunction> functions, string expressionString)
        {
            //Build a cachable numeric expression, interpolate the values and execute the expression.
        ...
        ///     executes all dependency functions to collapse the function to a single value.
        /// </summary>
        public static string CollapseAggregateFunction(Transaction transaction, PreparedQuery query,
