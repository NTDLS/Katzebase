...
namespace NTDLS.Katzebase.Engine.Parsers.Query.WhereAndJoinConditions
{
    internal class Old_Condition
    {
        ...
        public Old_Condition(string conditionKey, LogicalConnector logicalConnector,
        ...
        public Old_Condition Clone()
            => new Old_Condition(ConditionKey, LogicalConnector, Left.Clone(), LogicalQualifier, Right.Clone());
