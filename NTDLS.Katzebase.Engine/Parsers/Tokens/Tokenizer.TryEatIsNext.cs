namespace NTDLS.Katzebase.Engine.Parsers.Tokens
{
    internal partial class Tokenizer
    {
        ...
        /// </summary>
        public bool TryEatIsNext(string[] givenTokens, char[] delimiters)
        ...
        /// Moves the caret past the token only if its matched.
        /// </summary>
        public bool TryEatIsNext(string[] givenTokens)
        ...
        /// Moves the caret past the token only if its matched.
        /// </summary>
        public bool TryEatIsNext(string givenToken)
        ...
        /// Moves the caret past the token only if its matched.
        /// </summary>
        public bool TryEatIsNext(string givenToken, char[] delimiters)
        ...
        /// Moves the caret past the token only if its matched.
        /// </summary>
        public bool TryEatIsNext(string[] givenTokens, char[] delimiters, out string outFoundToken)
        ...
        /// Moves the caret past the token only if its matched.
        /// </summary>
        public bool TryEatIsNext(string[] givenTokens, out string outFoundToken)
        ...
        /// Moves the caret past the token only if its matched.
        /// </summary>
        public bool TryEatIsNext(string givenToken, out string outFoundToken)
        ...
        /// Moves the caret past the token only if its matched.
        /// </summary>
        public bool TryEatIsNext(string givenToken, char[] delimiters, out string outFoundToken)
