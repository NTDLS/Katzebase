...
namespace NTDLS.Katzebase.Engine.Interactions.Management
{
    ...
    public class SchemaManager
    {
        ...
        internal KbQueryResult Grant(Transaction transaction, string schemaName, Guid roleId, SecurityPolicyPermission permission, bool isRecursive)
        {
            try
            {
        ...
        internal KbQueryResult Deny(Transaction transaction, string schemaName, Guid roleId, SecurityPolicyPermission permission, bool isRecursive)
        {
            try
            {
                var physicalSchema = _core.Schemas.Acquire(transaction, schemaName, LockOperation.Write);
        ...
        internal KbQueryResult Revoke(Transaction transaction, string schemaName, Guid roleId, SecurityPolicyPermission permission)
        {
            try
            {
                var physicalSchema = _core.Schemas.Acquire(transaction, schemaName, LockOperation.Write);
