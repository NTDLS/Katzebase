...
namespace NTDLS.Katzebase.Engine.Interactions.APIHandlers
{
    ...
    public class DocumentAPIHandlers : IRmMessageHandler
    {
        ...
        public DocumentAPIHandlers(EngineCore core)
        {
            ...
            {
                Management.LogManager.Error($"Failed to instantiate document API handlers.", ex);
                throw;
            }
        }
        ...
        public KbQueryDocumentStoreReply StoreDocument(RmContext context, KbQueryDocumentStore param)
        {
            ...
            {
                Management.LogManager.Error($"Failed to execute document store for process id {session.ProcessId}.", ex);
                throw;
            }
        }
        ...
        public KbQueryDocumentCatalogReply DocumentCatalog(RmContext context, KbQueryDocumentCatalog param)
        {
            ...
            {
                Management.LogManager.Error($"Failed to execute document catalog for process id {session.ProcessId}.", ex);
                throw;
            }
        }
