...
namespace NTDLS.Katzebase.Engine.Trace
{
    internal class PerformanceTrace
    {
        ...
        /// <param name="counter">The performance category for instrumentation.</param>
        /// <returns></returns>
        internal PerformanceTraceDurationTracker? CreateToken(PerformanceCounter counter)
        ...
        internal PerformanceTraceDurationTracker? CreateToken(PerformanceCounter counter, string subCategory)
        ...
        /// <param name="counter">The performance category for instrumentation.</param>
        /// <returns>Token which is used to track time and via a call to StopAndAccumulate when finished.</returns>
        internal PerformanceTraceDurationTracker? CreateToken<SubCategoryT>(PerformanceCounter counter)
        ...
        /// Can be called directly, but is typically called via PerformanceTraceDurationTracker.StopAndAccumulate()
        /// </summary>
