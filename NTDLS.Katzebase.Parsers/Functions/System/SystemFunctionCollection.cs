...
namespace NTDLS.Katzebase.Parsers.Functions.System
{
    public static class SystemFunctionCollection
    {
        internal static string[] PrototypeStrings = {
                ...
                "Print(String expression)|'Writes a message to the result so that is can be returned via the query results.'",
                "RefreshMyRoles()|'Refreshes the security roles for the user logged into the current session.'",
                ...
                "ShowMySchemaPolicy(string schemaName)|'Returns the policies for the given schema as they will be applied for the currently logged in account.'",
                ...
                "Sleep(Numeric timeoutMilliseconds)|'Causes the executing thread to sleep for the specified number of milliseconds.'",
