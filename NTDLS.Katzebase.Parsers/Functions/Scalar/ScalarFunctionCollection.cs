...
namespace NTDLS.Katzebase.Parsers.Functions.Scalar
{
    public static class ScalarFunctionCollection
    {
        internal static string[] PrototypeStrings = {
                ...
                "Numeric Abs (Numeric value)|'Returns the absolute value of a specified number.'",
                "Numeric Ceil (Numeric value)|'Returns the smallest integral value greater than or equal to the specified number.'",
                ...
                "Numeric Floor (Numeric value,)|'Returns the largest integral value less than or equal to the specified number.'",
                ...
                "Numeric NullWhen (String value, String compareToValue)|'Returns null if the supplied value is equal to the compareToValue.'",
                "Numeric Pow (Numeric x, Numeric y)|'Returns a specified number raised to the specified power.'",
                "Numeric Round (Numeric value, Numeric decimalPlaces = 0)|'Returns the suppled number, rounded to the given decimal places.'",
