...
namespace Katzebase.Benchmark
{
    internal class Program
    {
        ...
        {
            File.AppendAllText(OutputFileName, $"{StartDateTime}\t{name}\t{iteration}\t{durationMs}\t{peakMemory}\t{cpuTime}\r\n");
            Console.WriteLine($"{name}\t{iteration}\t{durationMs}\t{peakMemory}\t{cpuTime}");
        }
    }
}
