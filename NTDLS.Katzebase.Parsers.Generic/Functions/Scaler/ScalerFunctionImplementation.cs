...
namespace NTDLS.Katzebase.Engine.Functions.Scaler
{
    ...
    internal class ScalerFunctionImplementation
    {
        ...
        public static TData? ExecuteFunction<TData>(ITransaction<TData> transaction, string functionName, List<TData?> parameters, KbInsensitiveDictionary<TData?> rowValues) where TData:IStringable
        {
