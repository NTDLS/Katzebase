namespace NTDLS.Katzebase.Client.Payloads
{
    ...
    public class KbQueryResultCollection<TData> : KbBaseActionResponse
    {
        public new double Duration => Collection.Sum(o => o.Duration);

        public List<KbQueryDocumentListResult<TData>> Collection { get; set; } = new();

        public KbQueryDocumentListResult<TData> AddNew()
        {
        ...
        public void Add(KbQueryResultCollection<TData> result)
        {
            Collection.AddRange(result.Collection);
        }

        public void Add(KbQueryDocumentListResult<TData> result)
        {
            Collection.Add(result);
        }
